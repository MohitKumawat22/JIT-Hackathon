...
export default function RemindersPage() {
 ...
 className="text-[10px] font-bold text-gray-400 hover:text-emerald-500 transition-colors uppercase tracking-widest border border-gray-200 px-3 py-1.5 rounded-lg"
 >
 Seed Data
 </button>
 ...
 <div className={`h-full transition-all ${med.remainingQuantity < 5 ?"bg-red-500" :"bg-[#10B981]"}`} style={{ width: `${(med.remainingQuantity / med.totalQuantity) * 100}%` }}
 ></div>
 </div>
