  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans overflow-x-hidden">
      ...
      <section className="relative overflow-hidden bg-white border-b border-gray-100">
        ...
        <div className="absolute top-0 right-0 w-[45%] h-[80%] bg-gradient-to-b from-[#10B981]/5 to-transparent rounded-bl-[100px] -z-10" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { 
              ...
              desc: "Round the clock medical support & emergency care.", 
              bg: "bg-gray-900", 
              text: "text-white",
              iconBg: "text-white bg-white/10"
            },
            { 
              ...
              title: "Easy Booking", 
              desc: "Book appointments with doctors in just 2 clicks.", 
              link: "/patient/login",
            ...
            { 
              ...
              desc: "Access certified specialists across 20+ departments.", 
              link: "/doctor/login",
              iconBg: "text-[#10B981] bg-emerald-50"
            },
            { 
              ...
              desc: "Describe symptoms & get home remedies and doctor recommendations.", 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                ...
                desc: "Describe how you feel and our AI analyzes your symptoms to suggest home remedies and the right specialist." 
              },
              { 
                ...
                desc: "Real-time geolocation-based search to find the nearest hospitals and clinics with directions." 
              },
              { 
      ...
      <section id="speciality" className="max-w-6xl mx-auto px-6 md:px-10 py-24">
        <div className="bg-gray-900 rounded-[2rem] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 overflow-hidden relative">
          <div className="absolute top-0 right-0 w-64 h-full bg-gradient-to-l from-[#10B981]/20 to-transparent -z-0"></div>
