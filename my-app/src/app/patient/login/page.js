...
export default function PatientLoginPage() {
 ...
 <div className="bg-white border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-8 sm:p-10">
 {/* Header */}
 <div className="text-center mb-8">
 <div className="w-14 h-14 mx-auto rounded-2xl from-[#10B981] to-[#059669] flex items-center justify-center mb-5 shadow-lg shadow-[#10B981]/20">
