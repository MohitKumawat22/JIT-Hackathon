...
const SEVERITY_KEYWORDS = {
 critical: ["chest pain","can't breathe","heart attack","stroke","unconscious","emergency","chest mein dard","saans nahi aa raha","hosh nahi","bahut bura condition"
 ],
 high: ["severe","hospital","ambulance","dizzy","vomiting","bahut bura lag raha","chakkar aa raha","ulti ho rahi","bahut tez dard"
 ],
 moderate: ["pain","fever","headache","nausea","tired","weak","dard ho raha","bukhar hai","sir dard","thaka hua","neend nahi ho rahi"
 ],
 low: ["okay","fine","better","good","theek hoon","better hoon","sab theek hai","achha lag raha","improve hua"
 ],
};
...
{"symptoms": [], // array of short strings, max 5 words each, in Hinglish"mood":"", // one word: positive / low / anxious / neutral / distressed"followUpTopics": [] // array of natural Hinglish follow-up questions for next call
}

Keep followUpTopics conversational — phrase them as AmritCare would actually ask them.

Few-shot example output:
{"symptoms": ["sir dard","thakaan","neend nahi ho rahi"],"mood":"low","followUpTopics": ["Sir dard better hua kya?","Neend kaisi rahi last few days?","Doctor se mil paaye kya?"
 ]
}`,
 },
 { role:"user", content: transcriptText },
