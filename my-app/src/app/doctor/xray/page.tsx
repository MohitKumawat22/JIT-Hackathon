...
export default function DoctorXRayTool() {
 ...
 <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-cyan-500/20">
 ...
 <div className="bg-slate-900 border border-white/[0.08] rounded-3xl p-8 md:p-12 shadow-2xl">
 {step ==="idle" && (
