...
export const MOCK_CASES: PatientCase[] = [
  {
    ...
    aiSummary:
      "AI triage indicates potential acute coronary syndrome. Immediate cardiology consult recommended. ECG & troponin prioritised.",
    timestamp: "2 min ago",
  ...
  },
  {
    ...
    originalSymptoms: [
      "حرارتي مرتفعة منذ ثلاثة أيام",
      "ألم شديد في البطن",
      "أشعر بالغثيان المستمر",
    ],
    translatedSymptoms: [
      "Fever persisting for three days",
      "Severe abdominal pain",
      "Constant nausea",
    ],
    aiSummary:
      "Suspected acute appendicitis or cholecystitis. Recommend urgent abdominal ultrasound and CBC with differential.",
    timestamp: "8 min ago",
  ...
  },
  {
    ...
    translatedSymptoms: [
      "Recurring headaches for two weeks",
      "Vision becoming blurred",
      "Neck is very stiff",
    ],
    aiSummary:
      "Pattern suggests tension-type headache with possible cervicogenic component. Rule out elevated ICP — recommend fundoscopy and BP monitoring.",
  ...
  },
  {
    ...
    aiSummary:
      "Likely viral upper respiratory infection. Symptomatic treatment recommended. No urgent intervention needed.",
  ...
  },
  {
    ...
    originalSymptoms: [
      "Mon bras gauche est devenu faible soudainement",
      "Je n'arrive plus à parler correctement",
      "Je suis très confuse",
    ],
    translatedSymptoms: [
      "My left arm suddenly became weak",
      "I can no longer speak properly",
      "I am very confused",
    ],
    aiSummary:
      "FAST-positive presentation. Suspected cerebrovascular accident. Code stroke activation recommended. CT-head STAT.",
    timestamp: "5 min ago",
  ...
  },
  {
    ...
    aiSummary:
      "Likely lateral ankle sprain, possible fracture. X-ray recommended. RICE protocol initiated.",
    timestamp: "1 hr ago",
