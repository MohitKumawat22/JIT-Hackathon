...
export default function DoctorVerify() {
 ...
 <div className="bg-slate-900 border border-white/[0.08] rounded-3xl p-8 shadow-2xl relative overflow-hidden">
 <div className="flex items-center gap-3 mb-6">
 <div className="p-2.5 rounded-xl to-teal-600">
 ...
 {/* Step 2: Face ID */}
 <div className={`bg-slate-900 border border-white/[0.08] rounded-3xl p-8 shadow-2xl transition-all duration-500 ${idStep !== 'done' ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
 <div className="flex items-center gap-3 mb-6">
 <div className="p-2.5 rounded-xl to-emerald-600">
 ...
 <div className="space-y-6">
 {faceStep ==="idle" && (
 <div className="h-48 border border-white/[0.08] rounded-2xl flex flex-col items-center justify-center bg-gray-900">
 ...
 <button onClick={handleFaceScan} className="bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-2 rounded-xl text-sm font-medium transition-colors shadow-lg shadow-emerald-600/20">
 Start Camera Scan
 </button>
 </div>
 )}
 ...
 {faceStep ==="scanning" && (
 <div className="h-48 border border-emerald-500/30 rounded-2xl flex flex-col items-center justify-center bg-gray-900 relative overflow-hidden">
 <div className="w-24 h-24 rounded-full border-2 border-emerald-500 flex items-center justify-center relative">
 <div className="absolute inset-0 border-t-2 border-white rounded-full animate-spin" />
 <div className="w-20 h-20 bg-emerald-500/20 rounded-full blur-md animate-pulse" />
 </div>
 <p className="text-sm font-medium text-emerald-300 mt-4 animate-pulse">Mapping facial landmarks...</p>
 </div>
 )}
 ...
 <div className="h-48 border border-emerald-500/30 rounded-2xl flex flex-col items-center justify-center bg-emerald-500/5">
 <CheckCircle className="w-12 h-12 text-emerald-400 mb-3" />
 <p className="text-lg font-bold text-emerald-400">Face ID Registered</p>
