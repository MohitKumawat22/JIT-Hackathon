...
export default function DoctorProfilePage() {
 ...
 className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all"
 >
 {SPECIALTIES.map((s) => (
 ...
 className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"
 />
 </div>
 </div>
 </div>
 ...
 isSelected ?"bg-emerald-600 text-white shadow-md scale-105" :"bg-gray-50 text-gray-300 hover:bg-emerald-50 hover:text-emerald-400"
 }`}
 >
 {isSelected ?"✓" :"+"}
 </button>
