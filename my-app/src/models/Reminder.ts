...
const ReminderSchema: Schema = new Schema(
 ...
 medicineType: { type: String, enum: ["tablet","capsule","syrup"], default:"tablet" },
 dosage: { type: String, required: true },
 frequency: { type: String, enum: ["once_daily","twice_daily","thrice_daily","once_weekly","alternate_days"], required: true },
