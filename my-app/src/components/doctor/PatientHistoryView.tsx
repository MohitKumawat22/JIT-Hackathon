  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
        ...
        {/* ── patient header ── */}
        <div className="bg-slate-900/70 backdrop-blur-xl border border-white/[0.06] rounded-2xl p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-violet-600/30">
          ...
          <div className="mt-5 bg-violet-500/10 border border-violet-500/20 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs uppercase tracking-wider text-violet-400 font-semibold">Current AI Triage Assessment</span>
            </div>
            <p className="text-sm text-violet-200/90 leading-relaxed">{patient.aiSummary}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Past Diagnoses */}
          <div className="bg-slate-900/70 backdrop-blur-xl border border-white/[0.06] rounded-2xl p-6">
                ...
                <div key={i} className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4 hover:bg-white/[0.05] transition-colors">
                  <div className="flex items-start justify-between mb-1">
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${
                      ...
                      d.status === "Ongoing" ? "bg-orange-500/15 text-orange-400" :
          ...
          {/* Current Medications */}
          <div className="lg:col-span-2 bg-slate-900/70 backdrop-blur-xl border border-white/[0.06] rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-5">
              <div className="p-2 rounded-lg bg-gradient-to-br from-rose-600 to-pink-600">
          ...
          {/* Security footer */}
          <div className="lg:col-span-2 bg-slate-900/40 border border-white/[0.04] rounded-xl p-4 flex items-center gap-3">
