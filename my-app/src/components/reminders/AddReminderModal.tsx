        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Alert me <input type="number" min="1" value={refillAlertDays} onChange={(e) => setRefillAlertDays(Number(e.target.value))} className="w-16 mx-2 border-b border-gray-400 text-center focus:border-blue-500 outline-none" /> days before running out
            </label>
          </div>
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-100">
            ...
            <button
              type="submit"
              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-md"
            >
              Add Reminder
            </button>
          </div>
