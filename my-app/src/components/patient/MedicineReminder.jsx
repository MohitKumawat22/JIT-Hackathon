...
export default function MedicineReminder({ patientId }) {
 ...
 {activeAlarm && (
 <div className="fixed inset-0 z-[100] flex items-center justify-center bg-red-600/90 p-6">
 ...
 <button onClick={() => { setActiveAlarm(null); if (audioRef.current) { audioRef.current.pause(); audioRef.current.currentTime = 0; } }}
